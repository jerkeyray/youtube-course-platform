    ...
    <div className="bg-white text-black">
        ...
        <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          <Card className="p-8 shadow-xl">
            <CardContent className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-lg">
                Watch YouTube playlists without distractions and stay focused on
                learning.
              </p>
            </CardContent>
          </Card>
          <Card className="p-8 shadow-xl">
            <CardContent className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-lg">
                Track which videos you've watched and see your completion rate.
              </p>
            </CardContent>
          </Card>
          <Card className="p-8 shadow-xl">
            <CardContent className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-lg">
                Turn any YouTube playlist into your own structured course.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-24 px-8 text-center">
        ...
        <ol className="max-w-4xl mx-auto space-y-8 text-left text-xl text-gray-800">
          <li>
            <strong>Step 1:</strong> Sign in using your Google or email account.
          </li>
          <li>
            <strong>Step 2:</strong> Paste a YouTube playlist link to create a
            course.
          </li>
          <li>
            <strong>Step 3:</strong> Watch videos and track your progress.
          </li>
          <li>
            <strong>Step 4:</strong> Take notes, set goals, and stay on track.
          </li>
        </ol>
      </section>
      ...
      <section className="bg-black text-white py-24 px-8 text-center">
        ...
        <Button
          size="lg"
          className="text-xl px-8 py-5 bg-white text-black font-bold hover:bg-gray-200"
          asChild
        >
          <Link href={getStartedLink}>Get Started</Link>
        </Button>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="q1">
              ...
              <AccordionContent className="text-gray-700 text-lg">
                Yes, Yudoku is free to use while in beta. We may introduce
            ...
            <AccordionItem value="q2">
              ...
              <AccordionContent className="text-gray-700 text-lg">
                No, but we recommend logging in with your Google account to
                enhance your experience.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="q3">
              <AccordionTrigger className="text-xl">
                Can I track my learning goals?
              </AccordionTrigger>
              <AccordionContent className="text-gray-700 text-lg">
                Absolutely. Yuco helps you set daily watch goals and track your
                progress.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <footer className="bg-gray-100 text-gray-700 py-10 px-8 text-center">
        <p className="text-lg">
          © {new Date().getFullYear()} Yudoku. All rights reserved.
        </p>
      </footer>
    </div>
  );
