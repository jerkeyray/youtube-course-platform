    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-white/20 hover:bg-white/10 text-white"
        ),
        ...
        day_selected:
          "bg-white text-black hover:bg-neutral-200 hover:text-black focus:bg-white focus:text-black",
        day_today: "bg-white/10 text-white",
        day_outside:
          "day-outside text-neutral-600 aria-selected:bg-white/5 aria-selected:text-neutral-400",
