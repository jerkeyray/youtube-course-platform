...
export default function DashboardClient({ courses }: DashboardClientProps) {
  ...
  const coursesWithDeadlines = courses
    ...
    .map((course) => {
      ...
      const pace =
        daysRemaining > 0
          ? (remainingVideos / daysRemaining).toFixed(1)
          : remainingVideos; // videos per day
        ...
        {nextTask ? (
          ...
          <div className="bg-[#0D1016] rounded-xl p-12 border border-white/5 text-center">
            ...
            <p className="text-neutral-400 mb-8 font-light">
              Add your first YouTube course to get started.
            </p>
            <Button
              asChild
              className="bg-white text-black hover:bg-neutral-200 px-8 h-12 text-base border-0"
            >
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {coursesWithDeadlines.map((course) => (
                ...
                >
                  <div
                    className={`h-full flex flex-col justify-between p-4 rounded-lg border transition-all duration-200 ${
                      course.isUrgent
                  ...
                  >
                    <div>
                      <h4 className="text-sm font-medium text-neutral-300 mb-1 line-clamp-1">
                        {course.title}
                      </h4>
        ...
        {(recentlyWatchedVideos.length > 0 || courses.length > 0) && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {recentlyWatchedVideos.length > 0 && (
              <div>
                <h3 className="text-base font-medium text-neutral-400 mb-3">
                  Recent
                </h3>
                    ...
                    >
                      <div className="flex items-center justify-between p-3 rounded-lg border border-white/5 bg-[#0D1016] hover:bg-white/5 hover:border-white/8 transition-all duration-200">
                        <div className="overflow-hidden mr-4">
                          <h4 className="text-sm font-normal text-neutral-300 group-hover:text-neutral-200 truncate">
                            {video.title}
                          </h4>
              ...
              <div>
                ...
                >
                  <div className="h-full flex flex-col justify-center items-center p-5 rounded-lg border border-white/5 bg-[#0D1016] hover:bg-white/5 hover:border-white/8 transition-all duration-200 text-center">
                    <span className="text-neutral-300 font-normal mb-1 group-hover:text-neutral-200">
                      View All Courses
                    </span>
                    <span className="text-xs text-neutral-600">
